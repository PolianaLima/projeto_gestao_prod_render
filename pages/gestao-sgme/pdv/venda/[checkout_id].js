...
function Checkout_id() {
    ...
    const finalizarVenda = async () => {
        ...
        try {
            await postVendas(dataRegisterVenda)
            ...
            {loadingData ? (
                ...
                <main className="mt-4 p-3">
                    <div className="d-sm-flex justify-content-between">
                        <div className="w-50 d-sm-flex " style={{height: '69vh'}}>
                        ...
                        <div className="w-100 d-sm-flex">
                            {itensVenda.length > 0 ? (
                                                ...
                                                <tr key={index} className="border-bottom ">
                                                    ...
                                                    <td>
                                                        <button className="border-0"
                                                            ...
                                                            <i className="bi bi-trash text-danger fw-bolder"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                            ))}
                                ...
                                <div
                                    ...
                                    <h1 className="">Seu caixa está <b className="text-info fs-1">livre</b> no
                                        momento!</h1>
